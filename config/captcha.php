...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | When disabled, the validation rule and middleware pass every request
    | through without inspecting the answer. Image generation keeps working
    | so local and staging front-ends still render something.
    |
